...
namespace invDFT
{
  ...
  public:
    ...
    void
    solveEigen(const std::vector<dftfe::distributedCPUVec<double>> &pot);

    void
    dotProduct(const dftfe::distributedCPUVec<double> &vec1,
...
//                                                  d_solutionPotVecForWritingInParentNodesMFVec;
    ...
    std::shared_ptr<dftfe::TransferDataBetweenMeshesIncompatiblePartitioning<memorySpace>> d_transferDataPtr;
    ...
    dftfe::chebyshevOrthogonalizedSubspaceIterationSolverDevice *d_subspaceIterationSolverDevice;
#endif

    dftfe::chebyshevOrthogonalizedSubspaceIterationSolver *d_subspaceIterationSolverHost;
