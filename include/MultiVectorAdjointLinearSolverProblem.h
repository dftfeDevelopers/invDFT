...
class MultiVectorAdjointLinearSolverProblem : public  dftfe::MultiVectorLinearSolverProblem<memorySpace>
  {
  public:
     ...
     *
     */
    void vmult(dftfe::linearAlgebra::MultiVector<dftfe::dataTypes::number ,
                                            memorySpace> &Ax,
          dftfe::linearAlgebra::MultiVector<dftfe::dataTypes::number ,
                                            memorySpace> &x,
     ...
     */
    void
    precondition_Jacobi(dftfe::linearAlgebra::MultiVector<dftfe::dataTypes::number ,
                                                          memorySpace> &      dst,
     ...
     */
    void
    precondition_JacobiSqrt(dftfe::linearAlgebra::MultiVector<dftfe::dataTypes::number ,
                                                               memorySpace> &      dst,
                            const dftfe::linearAlgebra::MultiVector<dftfe::dataTypes::number ,
                                                                    memorySpace> &src,
                            const double omega) const override ;
    ...
    void multiVectorDotProdQuadWise( dftfe::linearAlgebra::MultiVector<dftfe::dataTypes::number ,
                                                                 memorySpace> &      vec1,
dftfe::linearAlgebra::MultiVector<dftfe::dataTypes::number ,
                                                                       memorySpace> &vec2,
                               dftfe::utils::MemoryStorage<dftfe::dataTypes::number , dftfe::utils::MemorySpace::HOST>&
 ...
 dftfe::linearAlgebra::MultiVector<double,
    ...
    dftfe::utils::MemoryStorage<dftfe::dataTypes::number , memorySpace> vec1QuadValues, vec2QuadValues,vecOutputQuadValues;
