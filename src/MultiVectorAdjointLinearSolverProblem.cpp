...
//    computing_timer.enter_subsection("R times psi MemSpace MPI");
    ...
    const dftfe::dataTypes::number scalarCoeffAlpha = dftfe::dataTypes::number(1.0),
                            scalarCoeffBeta  = dftfe::dataTypes::number(0.0);
...
//    computing_timer.leave_subsection("psiTemp M^(-1/2) MemSpace MPI");
  ...
  template <dftfe::utils::MemorySpace memorySpace>
  void
  MultiVectorAdjointLinearSolverProblem<memorySpace>::multiVectorDotProdQuadWise(dftfe::linearAlgebra::MultiVector<dftfe::dataTypes::number ,
                                                                                                                         memorySpace> &      vec1,
                                                                                 dftfe::linearAlgebra::MultiVector<dftfe::dataTypes::number ,
                                                                                                                         memorySpace> &vec2,
  ...
  template <dftfe::utils::MemorySpace memorySpace>
  void
  MultiVectorAdjointLinearSolverProblem<memorySpace>::vmult(dftfe::linearAlgebra::MultiVector<dftfe::dataTypes::number ,
                                                                           memorySpace> &Ax,
                                                            dftfe::linearAlgebra::MultiVector<dftfe::dataTypes::number ,
                                                                                              memorySpace> &x,
                                         unsigned int blockSize)
