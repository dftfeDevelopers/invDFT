...
namespace invDFT
{
  ...
  InverseDFTEngine<FEOrder,FEOrderElectro,memorySpace>::InverseDFTEngine(dftfe::dftBase &       dft,
  ...
  template<unsigned int FEOrder, unsigned int FEOrderElectro, dftfe::utils::MemorySpace memorySpace>
  void InverseDFTEngine<FEOrder,FEOrderElectro,memorySpace>::createParentChildDofManager()
  {
        ...
        dftfe::triangulationManager dftTriaManagerVxc(d_mpiComm_parent,
            d_mpiComm_domain,
            d_mpiComm_interpool,
            d_mpiComm_bandgroup,
            1,
...
const std::vector<std::vector<double>> & domainBound = d_dftBaseClass->getCell();
  ...
  //  d_dofHandlerTriaVxc.reinit(parallelMeshMovedVxc);
    ...
    d_basisOperationsChildHostPtr = std::make_shared<dftfe::basis::FEBasisOperations<dftfe::dataTypes::number, double, dftfe::utils::MemorySpace::HOST>>
      (d_blasWrapperHost);
    ...
    */
    ...
    d_inverseDftDoFManagerObjPtr = std::make_shared<dftfe::TransferDataBetweenMeshesIncompatiblePartitioning<memorySpace>>(*d_dftMatrixFreeData,
                                                                                                       d_dftDensityDoFHandlerIndex,
                                                                                                       d_dftQuadIndex,
                                                                                                       d_matrixFreeDataVxc,
                                                                                                       d_dofHandlerVxcIndex,
  ...
  template<unsigned int FEOrder, unsigned int FEOrderElectro, dftfe::utils::MemorySpace memorySpace>
  void InverseDFTEngine<FEOrder,FEOrderElectro,memorySpace>::setInitialDensityFromGaussian(
    const std::vector<
...
//                  }
  ...
  template<unsigned int FEOrder, unsigned int FEOrderElectro, dftfe::utils::MemorySpace memorySpace>
  void InverseDFTEngine<FEOrder,FEOrderElectro,memorySpace>::setInitialPotL2Proj()
  {
    ...
    rhoData[dftfe::rhoDataAttributes::sigmaGradValue] =
      &d_sigmaGradRhoTarget;

    outputDerExchangeEnergy[dftfe::VeffOutputDataAttributes::derEnergyWithDensity] =
      &exchangePotentialVal;

    outputDerExchangeEnergy[dftfe::VeffOutputDataAttributes::derEnergyWithSigmaGradDensity] =
      &derExchEnergyWithSigmaValDummy;


    outputDerCorrEnergyDummy[dftfe::VeffOutputDataAttributes::derEnergyWithDensity] =
      &corrPotentialValDummy;

    outputDerCorrEnergyDummy[dftfe::VeffOutputDataAttributes::derEnergyWithSigmaGradDensity] =
      &derCorrEnergyWithSigmaValDummy;

    outputDerExchangeEnergyDummy[dftfe::VeffOutputDataAttributes::derEnergyWithDensity] =
    ...
    dftfe::dftUtils::constraintMatrixInfo<memorySpace> constraintsMatrixDataInfoPsi;
...
//    delete (excFunctionalPtrGGA);
  ...
  template<unsigned int FEOrder, unsigned int FEOrderElectro, dftfe::utils::MemorySpace memorySpace>
  void InverseDFTEngine<FEOrder,FEOrderElectro,memorySpace>::setAdjointBoundaryCondition(dftfe::distributedCPUVec<double> &rhoTarget)
  {
    /*
...
*/
    ...
    d_basisOperationsAdjointHostPtr.resize(2, std::make_shared<dftfe::basis::FEBasisOperations<dftfe::dataTypes::number,
                                                                                      double,
    ...
    d_basisOperationsAdjointMemSpacePtr.resize(2,std::make_shared<dftfe::basis::FEBasisOperations<dftfe::dataTypes::number, double, memorySpace>>
  ...
  template<unsigned int FEOrder, unsigned int FEOrderElectro, dftfe::utils::MemorySpace memorySpace>
  void InverseDFTEngine<FEOrder,FEOrderElectro,memorySpace>::computeHartreePotOnParentQuad(
    dftfe::utils::MemoryStorage<double,dftfe::utils::MemorySpace::HOST> &hartreeQuadData)
  {
    unsigned int numElectrons = d_dftBaseClass->getNumElectrons();
...
//                                << "\n";
    ...
    dftfe::poissonSolverProblem<FEOrder, FEOrderElectro> poissonSolverObj(d_mpiComm_domain);
    ...
    dftfe::dealiiLinearSolver dealiiLinearSolverObj(d_mpiComm_parent,d_mpiComm_domain, dftfe::dealiiLinearSolver::CG);
    ...
    dealiiLinearSolverObj.solve(poissonSolverObj,
      ...
      dftfe::dftUtils::constraintMatrixInfo<dftfe::utils::MemorySpace::HOST> constraintsMatrixDataInfoElectro;
  ...
  template<unsigned int FEOrder, unsigned int FEOrderElectro, dftfe::utils::MemorySpace memorySpace>
  void InverseDFTEngine<FEOrder,FEOrderElectro,memorySpace>::setPotBaseExactNuclear()
  {
    unsigned int numElectrons = d_dftBaseClass->getNumElectrons();
    // set up the constraints and the matrixFreeObj
    pcout << " numElectrons = " << numElectrons << "\n";
...
//                                << "\n";
  ...
  template<unsigned int FEOrder, unsigned int FEOrderElectro, dftfe::utils::MemorySpace memorySpace>
  void InverseDFTEngine<FEOrder,FEOrderElectro,memorySpace>::setPotBasePoissonNuclear()
  {
    unsigned int numElectrons = d_dftBaseClass->getNumElectrons();
    // set up the constraints and the matrixFreeObj
    pcout << " numElectrons = " << numElectrons << "\n";
...
const unsigned int nLocallyOwnedCells = d_dftMatrixFreeData->n_physical_cells();
  ...
  template<unsigned int FEOrder, unsigned int FEOrderElectro, dftfe::utils::MemorySpace memorySpace>
  void InverseDFTEngine<FEOrder,FEOrderElectro,memorySpace>::readVxcDataFromFile(
  ...
  void InverseDFTEngine<FEOrder,FEOrderElectro,memorySpace>::run()
  {
    ...
    dftfe::KohnShamHamiltonianOperator<memorySpace> *kohnShamClassPtr = d_dftBaseClass->getOperatorClass();
  ...
  void InverseDFTEngine<FEOrder,FEOrderElectro,memorySpace>::testAdjoint()
  {
	  ...
	  MultiVectorAdjointLinearSolverProblem<memorySpace> multiVectorAdjointProblem(d_mpiComm_parent,
			  d_mpiComm_domain);
    dftfe::MultiVectorMinResSolver multiVectorLinearMINRESSolver(d_mpiComm_parent,
                          d_mpiComm_domain);
    ...
    unsigned int currentBlockSize =d_numEigenValues;
        const dftfe::utils::MemoryStorage<dftfe::dataTypes::number,
                                      memorySpace>
